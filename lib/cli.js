...
// /home/benrobo/Documents/Projects/java-compiler-cli/temp/kola.java
...
const compileJavaCode = async (filename, code = "", ext, cb) => {
  ...
  // cd /home/benrobo/Documents/Projects/java-compiler-cli/temp && java Main.java
...
const compileJavaFile = async (filename, cb) => {
  const codeDir = path.join(__dirname, "../", `javaTestFile/${filename}.java`);
